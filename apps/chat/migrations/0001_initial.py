    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_chat_threads', to=settings.AUTH_USER_MODEL)),
